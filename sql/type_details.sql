...
INSERT INTO `type_details` VALUES (3, 103, '会议材料', -1, '综合', '学院党委（党总支）会议、党政联席会议和学术委员会研究教学工作的会议记录以及会议纪要');
...
INSERT INTO `type_details` VALUES (9, 205, '教师业务档案', -1, '教师队伍', '教师业务档案（学历、学位证书、教师资格证书、职称证书；承担教学任务情况、教研与科研情况，按人立券）');
